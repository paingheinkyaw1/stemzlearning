      ...
      <div className="max-w-[1074px] mx-auto rounded-[12px] border border-black/10 pt-9 px-16 pb-0 bg-white overflow-hidden">
        <div className="pb-9">
          ...
          <div className="mt-5 flex justify-center">
            <p className="text-center text-[15px] md:text-[16px] leading-relaxed w-[946px] max-w-full text-black">
        ...
        <div className="relative mt-20 -mx-16">
          ...
          <div className="relative grid grid-cols-2">
            <div className="bg-[#FFF9F9] border-b border-zinc-300/60 flex items-center justify-center py-7 text-black">
              <p className="text-[15px] md:text-[16px] text-center">
                Limited engaging opportunities
              </p>
            </div>
            <div className="bg-[#EDF3EA] border-b border-l border-zinc-300/60 flex items-center justify-center py-7 text-black">
              <p className="text-[15px] md:text-[16px] text-center">
